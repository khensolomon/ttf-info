...
function resultTables(data) {
  ...
  // var data = (arrayBuffer.constructor === ArrayBuffer)?new DataView(arrayBuffer, 0, arrayBuffer.byteLength):arrayBuffer;
  // var data = (arrayBuffer instanceof Buffer)?new DataView(arrayBuffer, 0, arrayBuffer.byteLength):arrayBuffer;
  // let data = (arrayBuffer instanceof ArrayBuffer)?new DataView(arrayBuffer.buffer, 0, arrayBuffer.length):arrayBuffer;
...
/**
 * @namespace
 * @param {string | number | Buffer | URL | DataView} data
...
export function ttfInfo(data, callback) {
  try {
    ...
    // console.log(string | ArrayBuffer);
